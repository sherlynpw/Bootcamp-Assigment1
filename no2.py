class Account:
    ...
    def store(self, money: int):
        ...
        if (money > 0):
            ...
            print('You have successfully store ${}. You now have ${} in your balance.'.format (str(money), str(self.balance)))
        else:
    ...
    def withdraw(self, money: int):
        ...
        if (money < self.balance):
            self.balance = self.balance - money
            print('You have successfully withdraw ${}. You now have ${} in your balance.'.format (str(money), str(self.balance)))
        else:
            print('You do not have enough money to withdraw. You only have ${}'.format (str(self.balance)))
        #pass
...
class Customer:
    ...
    def delete_account(self, account_name: str):
        ...
        if account_name in self.accounts:
            ...
            print('The account {} has been deleted.'.format(account_name))
        else:
            print('There is no account named {}.'.format(account_name))
...
class Bank:
    ...
    def delete_customer(self, name: str):
        ...
        if name in self.customers:
            ...
            print('The customer {} has been deleted.'.format(name))
        else:
            print('There is no customer named {}.'.format(name))
    ...
    def generate_report_per_customer(self, customer: Customer):
        ...
        """
        if customer is None:
            print('Customer with name {} does not exist'.format(customer.name))
        else:
            totalAll = 0
            for account_name, account in customer.accounts.items():
                totalAll = totalAll + account.balance
                print(account_name, account.balance)
            print('Your total balance is ${}.'.format(totalAll))
